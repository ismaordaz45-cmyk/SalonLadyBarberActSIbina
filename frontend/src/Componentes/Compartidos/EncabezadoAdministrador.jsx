...
const EncabezadoAdministrativo = () => {
  ...
  return (
    <>
      ...
      <header className="flex justify-between items-center px-6 py-5 bg-gradient-to-r from-[#2C3E50] to-[#1A252F] text-white relative shadow-lg z-50">
        {/* Logo */}
        <div className="flex items-center flex-1">
          {logoUrl && <img src={logoUrl} alt="Logo de la Empresa" className="w-14 h-14 rounded-full mr-3 shadow-md border-2 border-[#D4AF37]" />}
          <h3 className="text-2xl font-bold tracking-wide text-[#F9FAFB]">{nombreEmpresa}</h3>
        </div>
        ...
        <nav className="hidden md:flex flex-1 justify-end ml-8" ref={menuRef}>
          <ul className="flex items-center gap-2 list-none m-0 p-0">
            ...
            >
              <HomeOutlined style={{ color: '#D4AF37', fontSize: 22 }} />
              Inicio
            </li>
            ...
            <li className="group relative cursor-pointer px-4 py-2 rounded-lg transition-all duration-300 ease-in-out flex items-center gap-2 text-base font-medium hover:bg-emerald-400/20 hover:shadow-md">
              <span onClick={() => toggleDropdown('empresa')}>
                <FileTextOutlined style={{ color: '#FACC6B', fontSize: 20 }} />
                Datos de la Empresa
              </span>
            ...
            <li className="group relative cursor-pointer px-4 py-2 rounded-lg transition-all duration-300 ease-in-out flex items-center gap-2 text-base font-medium hover:bg-emerald-400/20 hover:shadow-md">
              <span onClick={() => toggleDropdown('gestiongeneral')}>
                <ShopOutlined style={{ color: '#4ADE80', fontSize: 20 }} />
                Gestión General
              </span>
              <ul className="absolute left-0 top-full hidden group-hover:block bg-slate-800 rounded-lg shadow-xl mt-2 min-w-[200px] py-2 z-50 border border-slate-700">
                <li 
            ...
            >
              <TeamOutlined style={{ color: '#38BDF8', fontSize: 20 }} />
              Gestión de Usuarios
            </li>
            ...
            >
              <UserOutlined style={{ color: '#F9A8D4', fontSize: 20 }} />
              Perfil
            </li>
            ...
            >
              <LogoutOutlined style={{ color: '#F97373', fontSize: 22 }} />
              Cerrar Sesión
            </li>
          </ul>
        </nav>
